...
if __name__ == "__main__":
    ...
    with tf.Session() as s:
        ...
        k0 = (
            ...
            .get_tensor_by_name("conv4d_valid_3dchan0/kernel:0")
            .eval()
            .flatten()
        )
        k1 = (
            tf.get_default_graph()
            .get_tensor_by_name("conv4d_valid_3dchan1/kernel:0")
            .eval()
            .flatten()
        )
        k2 = (
            tf.get_default_graph()
            .get_tensor_by_name("conv4d_valid_3dchan2/kernel:0")
            .eval()
            .flatten()
        )
